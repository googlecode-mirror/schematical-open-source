...
<div class="container clearfix">
	<div class='grid7 first'>    
		...
		<p><a href='#' class='MFBSubmitButton button large'>Submit Entry</a></p>

	</div>
    <div class="grid5">
    <div class="note rounded">
    <h4>Instructions</h4>
    <p>Boudin sausage ham hock pork loin chuck, swine short ribs strip steak hamburger beef ribs pig fatback.</p>
    </div>
    </div>
 </div>
 </div>
